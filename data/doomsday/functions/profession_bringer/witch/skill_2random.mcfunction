...
execute if score @s ddy_random matches 0..924 run effect give @a[limit=1,sort= random,team=ddy_guard] slowness 5 3 false
execute if score @s ddy_random matches 925..1849 run effect give @a[limit=1,sort= random,team=ddy_guard] instant_damage 1 3 false
execute if score @s ddy_random matches 1850..2774 run effect give @a[limit=1,sort= random,team=ddy_guard] poison 5 3 false
execute if score @s ddy_random matches 2775..3699 run effect give @a[limit=1,sort= random,team=ddy_guard] wither 5 3 false
execute if score @s ddy_random matches 3700..4624 run effect give @a[limit=1,sort= random,team=ddy_guard] nausea 5 3 false
execute if score @s ddy_random matches 4625..5549 run effect give @a[limit=1,sort= random,team=ddy_guard] blindness 5 3 false
execute if score @s ddy_random matches 5550..6479 run effect give @a[limit=1,sort= random,team=ddy_guard] levitation 2 3 false
